...
public class BinarySearchTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
  ...
  public static boolean test1() {
    ...
    newTree.rotate(newTree.findNode("X"), newTree.findNode("M"));

    String actual = newTree.toLevelOrderString();

    String expected = "[ X, M, Z, F, P, A, J ]";
  ...
  public static boolean test2() {
    ...
    newTree.rotate(newTree.findNode("E"), newTree.findNode("M"));

    String actual = newTree.toLevelOrderString();
    String expected = "[ E, D, M, Y, Q, Z ]";
    if (actual.equals(expected)) {
      return true;
    }
  ...
  public static boolean test3() {
    ...
    // System.out.println(newTree.toLevelOrderString());
    newTree.rotate(newTree.findNode("G"), newTree.findNode("F"));

    // System.out.println(newTree.toLevelOrderString());
    String actual = newTree.toLevelOrderString();

    String expected = "[ J, G, R, F, O, S, B ]";
